	...
	*/
	...
	public void TestSeatsAvailable() {
		try {
			...
			Ride ride = new Ride(0, driver, 5, "start", "finish", LocalDate.of(2050, 1, 1), LocalTime.of(10, 0));
	...
	public void TestRequestSeat_FullRide() {
		...
		try {
			...
			driver.addRole(new Passenger());
			driver.addRole(new Driver(new License("licensecode", LocalDate.parse("2100-01-01"))));
			Ride ride = new Ride(0, driver, 2, "start", "finish", LocalDate.of(2050, 1, 1), LocalTime.of(10, 0));
			...
			//assertEquals("Cannot send request: the ride is full.", expected.getMessage());
	...
	public void TestRequestSeat_RideInThePast() {
		...
		try {
			...
			Ride ride = new Ride(0, driver, 2, "start", "finish", LocalDate.of(1950, 1, 1), LocalTime.of(10, 0));
